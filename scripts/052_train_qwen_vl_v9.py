...
MAX_FRAMES     = 8
MIN_FRAMES     = 4
CHECKPOINT_DIR = "/workspace/checkpoints_vl_v9"
...
manifest = {
    "run_id": f"fls_round2_vl_v9_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
    "base_model": MODEL_ID, "adapter": "LoRA r=32 (LM) + visual.merger unfrozen",
    "data_source": "youtube_sft_v4 = v4 + gold + LASANA rescore (task5 at 24 frames, FLS clamped to [0,max])",
