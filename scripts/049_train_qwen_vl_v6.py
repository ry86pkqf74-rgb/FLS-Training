#!/usr/bin/env python3
"""FLS Round 2 v6 — Qwen2.5-VL LoRA trained on merged v002 pool (~1000 examples).
...
MAX_FRAMES     = 8
MIN_FRAMES     = 4
CHECKPOINT_DIR = "/workspace/checkpoints_vl_v6"
...
BATCH = 1; GRAD_ACCUM = 4; EPOCHS = 8; LR = 1e-4
...
manifest = {
    "run_id": f"fls_round2_vl_v6_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
    ...
    "supersedes": "047_train_qwen_vl_v5.py (v5 mode-collapsed; LR too high, rank too low)",
}
