...
memory/model_checkpoints/round2_vl_v11/DIAGNOSIS.md.
...
MAX_FRAMES     = 8
MIN_FRAMES     = 4
CHECKPOINT_DIR = "/workspace/checkpoints_vl_v11"
...
manifest = {
    "run_id": f"fls_round2_vl_v11_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
    "base_model": MODEL_ID, "adapter": "LoRA r=32 (LM) + visual.merger unfrozen",
    "data_source": "youtube_sft_v6 = v4 + gold + LASANA rescore (task5 at 24 frames, FLS clamped to [0,max])",
