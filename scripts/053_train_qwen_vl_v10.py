...
memory/model_checkpoints/round2_vl_v10/DIAGNOSIS.md.
...
MAX_FRAMES     = 8
MIN_FRAMES     = 4
CHECKPOINT_DIR = "/workspace/checkpoints_vl_v10"
...
manifest = {
    "run_id": f"fls_round2_vl_v10_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
